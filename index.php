	...
	<body class="one-page">
		...
		<div class="page-content uncover-footer-body">
								...
								<div class="navbar-collapse nav-collapse collapse collapsing-nav">
									...
									<ul class="nav navbar-nav">
										<li class="dropdown active">
											<a href="#javier_diaz">Javier Diaz</a>
										</li>
										<li>
			...
			<div class="uncover-footer-content">
								...
								<div class="col-sm-6 col-sm-offset-6 side-image-content pad-top-100 pad-bot-100">
									<div class="row">
										<div class="col-xs-10 col-xs-offset-1 pad-top-10 pad-bot-10 wow animated fadeInRight" data-wow-delay="200ms">
											<h2 class="no-margin text-uppercase letter-spacing-3">Catedrático, promotor de la cultura y escritor.</h2>
												...
												Es Presidente y Director General del Centro Mexicano de Capacitación y Servicios Educativos, 
                                                                                                ...
                                                                                                <br/><br/>
                                                                                                Coautor de importantes obras de divulgación, es autor, entre otros libros, de Aprender para Saber, Detalles 
                                                                                                del Pensamiento I y Te lo digo a ti, una obra fundamental para hablar al público.
                                                                                                <br/><br/>
                                                                                                De su amplia trayectoria como promotor, organizador y gestor de cientos de compromisos, destaca la fundación 
                                                                                                del primer servicio en el mundo, fuera de los Estados Unidos, de contratación de personalidades para ofrecer conferencias.
                                                                                                <br/><br/>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-12 text-center wow animated fadeIn" data-wow-delay="200ms">
									...
									<h2 class="text-light no-margin text-center text-uppercase letter-spacing-3">More To Get Excited About</h2>
				...
				<!-- One Page Section - Portfolio + Section Pattern -->
				
				<section id="publicaciones" class="section-pattern clearfix no-margin no-padding-bottom one-page-section" style="background-image:url('images/patterns/handmadepaper.png');">
					<div class="container-fluid no-padding">
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1 text-center">
								<div class="wow animated fadeIn" data-wow-delay="200ms">
									<p class="text-lighter letter-spacing-2"><i>Nulla consequat massa quis enim</i></p>
									<h2 class="no-margin text-center text-uppercase letter-spacing-3">Work Like There's No Tomorrow</h2>
									<div class="symbol">
								...
								<div class="btn-curtain mar-bot-100">
									<a class="btn btn-lg letter-spacing-3" href="#">View All Works</a>		
								</div>  
							</div>
						</div>
						<div class="row">
				...
				</section><!-- End of One Page Section - Portfolio + Section Pattern -->
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1 wow animated fadeIn" data-wow-delay="200ms">
									...
									<h2 class="text-light no-margin text-center text-uppercase letter-spacing-3">More To Know & Love</h2>
									<div class="symbol symbol-theme">
						...
						<div class="row vertical-center-box">
							<div class="col-md-6 pad-top-100 pad-bot-100" style="background-color:#f6f6f6;">
								<div class="pad-top-100 pad-bot-100">
									<div class="wow animated fadeIn" data-wow-delay="200ms">
										<p class="text-lighter letter-spacing-2 text-center"><i>Nulla consequat massa quis enim</i></p>
										<h2 class="no-margin text-center text-uppercase letter-spacing-3">Contact Info</h2>
										<div class="symbol">
							...
							<div class="col-md-6 text-center pad-top-100-tablet pad-top-100-mobile pad-bot-100-tablet pad-bot-100-mobile">
								<div class="pad-top-100-tablet pad-top-100-mobile pad-bot-100-tablet pad-bot-100-mobile">
									<div class="wow animated fadeIn" data-wow-delay="200ms">
										<p class="text-lighter letter-spacing-2 text-center"><i>Nulla consequat massa quis enim</i></p>
										<h2 class="no-margin text-center text-uppercase letter-spacing-3">Drop Us a Line</h2>
										<div class="symbol">
											...
											<!-- Form - Grey + Medium -->
												...
												<div class="col-sm-6 wow animated slideInRight" data-wow-delay="200ms">
													<div class="form-group">
														<label class="control-label letter-spacing-3"><small><i>Email</i></small></label>
						...
						<div class="row">
							<div class="col-sm-12 text-center">
								<ul class="list-unstyled list-inline footer-inline-links">
									...
									<li><a href="#Javier_diaz">Javier Diaz</a></li>
