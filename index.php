...
"
                    ...
                    <div class="container-fluid">
                        <div class="row pad-top-50 pad-bot-50" style="background-color: #F2F2F2">
                            ...
                            <div class="col-md-6 col-sm-6 text-center no-padding-side counter-border">
                                <div class="nc-simple pad-top-50 pad-bot-50">
                                    <span class="fa fa-microphone fa-5x"></span><br/>
                                    <span class="counter">300</span><span class="counter-extend">+</span>
                            ...
                            <div class="col-md-6 col-sm-6 text-center no-padding-side counter-border">
                                <div class="nc-simple pad-top-50 pad-bot-50">
                                    ...
                                    <h4 class="text-uppercase letter-spacing-2">Cursos, talleres y seminarios</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="grid-4 portfolio portfolio-dark effect-4 filterArea list-unstyled">
                                    ...
                                    <li class="item nature">
                                        <figure>
                                            <img alt="image" src="images/detalles_del_pensamiento.jpg"  />
                                            <figcaption>
                                    ...
                                    <li class="item people">
                                        <figure>
                                            <img alt="image" src="images/publicacion_2.jpg"  />
                                            <figcaption>
                                                <div>
                                    ...
                                    <li class="item abstract">
                                        <figure>
                                            <img alt="image" src="images/publicacion_3.jpg"  />
                                            <figcaption>
                                                <div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1 wow animated fadeIn" data-wow-delay="200ms">
                                <h2 class="no-margin text-center text-uppercase letter-spacing-3" style="color:transparent">Catálogo de talleres, cursos y conferencias</h2>
                                <br>
                    ...
                    <div class="container " >
                            ...
                            <div class="row ">
                                <div class="col-md-12 col-lg-12 center-block" >
                                    ...
                                    <ul class="grid-3 grid-gutter-big grid-dark portfolio-dark portfolio effect-2 filterArea list-unstyled">
                ...
                <div id="contact" class="one-page-section"  >
                    <div class="container-fluid no-padding" >
                        ...
                        <div class="row vertical-center-box">
                            <div class="col-md-6 pad-top-40 pad-bot-100" style="background-color:#fff;" >
                                <div >
                                    <div class="wow animated fadeIn" data-wow-delay="200ms">
                            ...
                            <div class="col-md-6 text-center pad-top-50-tablet pad-top-50-mobile pad-bot-50-tablet pad-bot-50-mobile" style="background-color:#f6f6f6;" >
                                <div class="pad-top-50-tablet pad-top-50-mobile pad-bot-50-tablet pad-bot-50-mobile" >
                                    <div class="wow animated fadeIn" data-wow-delay="200ms">
                                        <!--<p class="text-lighter letter-spacing-2 text-center"><i>Nulla consequat massa quis enim</i></p>-->
                                        <h2 class="no-margin text-center text-uppercase letter-spacing-3 mar-top-30" >Escríbenos</h2>
